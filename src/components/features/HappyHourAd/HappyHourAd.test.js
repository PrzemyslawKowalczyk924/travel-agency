...
describe('Component HappyHourAd when open page', () => {
  checkDescriptionAtTime('12:00:00', mockProps.promoDescription);
  checkDescriptionAtTime('12:30:59', mockProps.promoDescription);
  checkDescriptionAtTime('12:59:59', mockProps.promoDescription);  
});

describe('Component HappyHourAd when time go to 0', () => {
  checkDescriptionAfterTime('11:59:58', 1, '1');
  checkDescriptionAfterTime('12:00:00', 1, mockProps.promoDescription);
  checkDescriptionAfterTime('12:42:59', 1, mockProps.promoDescription);
});